defmodule PelnanceWeb.TransactionLiveTest do
  use PelnanceWeb.ConnCase

  import Phoenix.LiveViewTest
  import Pelnance.TransactionsFixtures

  @create_attrs %{date: "2024-05-02", description: "some description", amount: "120.5"}
  @update_attrs %{date: "2024-05-03", description: "some updated description", amount: "456.7"}
